...
namespace MathLibraryTests
{
	...
	public:
		...
		{
			Mat3 m3b(-0.188076824f, 0.f, 0.982154310f,
				0.f, 1.f, 0.f,
			...
			Assert::AreEqual(Vec3(-849.156067f, -48.23f, -148.863144f), v3b);
		}
		// mat3 * mat3
		TEST_METHOD(OperatorMultiplyMat3Mat3)
		{
			Mat3 m3a(1, 3, 1, 2, 2, 2, 3, 1, 3);
			Mat3 m3c(4, 6, 4, 5, 5, 6, 6, 4, 5);

			Mat3 m3d = m3a * m3c;

			Assert::AreEqual(Mat3(28, 28, 28, 33, 31, 33, 29, 31, 29), m3d);
		}
		// make identity
